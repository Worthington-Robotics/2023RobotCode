...
public class PPActionGroup {
     ...
     * @param marker the marker at the action will be executed
     */
    PPActionGroup(Action[] actions, String marker, long timeout_ms) {
     ...
     * @param marker the marker at the action will be executed
     */
    PPActionGroup(Action action, String marker, long timeout_ms) {
        t_Timeout = (double) timeout_ms / 1000.000;
        e_Marker = marker;
        group = new LinkedList<>();
        group.add(action);
