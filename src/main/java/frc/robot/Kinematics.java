...
public class Kinematics {
    ...
    public static Twist2d forwardKinematics(double left_wheel_delta, double right_wheel_delta) {
        double delta_rotation = (right_wheel_delta - left_wheel_delta) / (Constants.DRIVE_WHEEL_TRACK_WIDTH * Constants.TRACK_SCRUB_FACTOR);
    ...
    public static DriveSignal inverseKinematics(Twist2d velocity) {
        ...
        double delta_v = Constants.DRIVE_WHEEL_TRACK_WIDTH * velocity.dtheta / (2 * Constants.TRACK_SCRUB_FACTOR);
