...
public class AdvBlueRightSideAuto extends StateMachineDescriptor {
    public AdvBlueRightSideAuto() {
        ...
        //END CONE
        addParallel(new Action[] {new NonblockingMoveAction(170 * Constants.ENCODER_PER_INCH, 0), new ReachLineWaitAction(true, 80 * Constants.ENCODER_PER_INCH), new ArmPoseAction(ArmPose.UNSTOW)}, 8000);
