...
public class AdvBlueRightSideAuto extends StateMachineDescriptor {
    public AdvBlueRightSideAuto() {
        ...
        addSequential(new PoseWaitAction(), 10000);
        ...
        //END CONE
        addParallel(new Action[] {new NonblockingMoveAction(174 * Constants.ENCODER_PER_INCH, 0), new ReachLineWaitAction(true, 80 * Constants.ENCODER_PER_INCH), new ArmPoseAction(ArmPose.UNSTOW)}, 8000);
        ...
        addParallel(new Action[] {new NonblockingMoveAction(-170 * Constants.ENCODER_PER_INCH, 0), new ArmPoseAction(ArmPose.TRANSIT), new ReachLineWaitAction(false, -120 * Constants.ENCODER_PER_INCH)}, 13000);
