...
public class AdvRedRightSideAuto extends StateMachineDescriptor {
    public AdvRedRightSideAuto() {
        ...
        addParallel(new Action[] {new NonblockingMoveAction(160 * Constants.ENCODER_PER_INCH, 0), new ReachLineWaitAction(true, 80 * Constants.ENCODER_PER_INCH)}, 8000);
        ...
        // addParallel(new Action[] {new RotateTurretAction(173 * Constants.TURRET_TPD, false), new PoseWaitAction()}, 1750);
        // addSequential(new TimeWaitAction(), 250);
        // addSequential(new RunIntakeAction(Constants.ANYTHING_OUT_POWER), 250);
    }
}
