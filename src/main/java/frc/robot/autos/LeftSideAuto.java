...
public class LeftSideAuto extends StateMachineDescriptor {
    public LeftSideAuto() {
        ...
        addParallel(new Action[] {new UnblockingMoveAction(25 * Constants.ENCODER_PER_INCH, 0), new RotateTurretAction(-15 * Constants.TURRET_TPD, false), new AutoPipelineAction(LimelightPipeline.Low), new ReachLineWaitAction(true, 23 * Constants.ENCODER_PER_INCH)}, 4000); //move forward to get to the target
