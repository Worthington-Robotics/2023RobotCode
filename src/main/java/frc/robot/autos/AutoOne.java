...
public class AutoOne extends StateMachineDescriptor {
    public AutoOne() {
        ...
        addParallel(new Action[] {new MoveForwardAction(166.5 * Constants.ENCODER_PER_INCH, 0), new RotateTurretAction(0, false), new ArmPoseAction(ArmPose.INTAKE_LITE)}, 6500);

        addSequential(new ArmPoseAction(ArmPose.CUBE_MID_FRONT),50); //put the robot into the set pose
        addParallel(new Action[] {new RotateTurretAction(0, false), new PoseWaitAction()}, 1500);
