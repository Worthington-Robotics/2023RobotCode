...
public class AdvBlueLeftSideAuto extends StateMachineDescriptor {
    public AdvBlueLeftSideAuto() {
        ...
        //END CONE
        addParallel(new Action[] {new NonblockingMoveAction(170 * Constants.ENCODER_PER_INCH, 0), new ReachLineWaitAction(true, 70 * Constants.ENCODER_PER_INCH), new ArmPoseAction(ArmPose.UNSTOW)}, 8000);
        ...
        addParallel(new Action[] {new NonblockingMoveAction(-176 * Constants.ENCODER_PER_INCH, 0), new ArmPoseAction(ArmPose.TRANSIT), new ReachLineWaitAction(false, -120 * Constants.ENCODER_PER_INCH)}, 13000);
