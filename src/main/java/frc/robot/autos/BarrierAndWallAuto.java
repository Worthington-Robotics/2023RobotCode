...
public class BarrierAndWallAuto extends StateMachineDescriptor{
    ...
    public BarrierAndWallAuto() {
        ...
        addSequential(new DriveNonblockingLineAction(-3, 0, -3.5 * Constants.DRIVE_ENCODER_TO_METERS, 0, 0), 5000);
        addSequential(new ReachLineWaitAction(-3.5 * Constants.DRIVE_ENCODER_TO_METERS), 6000);
        addSequential(new AutoTurnAction(Math.PI * (- 17.0 / 18.0)), 3000);
        addSequential(new ArmPoseAction(ArmPose.INTAKE), 250);
        addSequential(new PoseWaitAction(), 5000);
        addSequential(new AutoTurnAction(Math.PI * (- 14.0 / 18.0)), 3000);
        addSequential(new DriveNonblockingLineAction(1, 0, - 2.2 * Constants.DRIVE_ENCODER_TO_METERS, 0, Math.PI * (- 14.0 / 18.0)), 3000);
        //addSequential(new RunIntakeAction(Constants.INTAKE_POWER, false), 3000);
        ...
        addSequential(new DriveNonblockingLineAction(3, 0, 4.5 * Constants.DRIVE_ENCODER_TO_METERS, 0, 0), 5000);
