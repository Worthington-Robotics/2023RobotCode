...
public class BlueRightSideAuto extends StateMachineDescriptor {
    public BlueRightSideAuto() {
        ...
        addParallel(new Action[] {new UnblockingMoveAction(25 * Constants.ENCODER_PER_INCH, 0), new RotateTurretAction(15 * Constants.TURRET_TPD, false), new AutoPipelineAction(0), new ReachLineWaitAction(true, 23 * Constants.ENCODER_PER_INCH)}, 4000); //move forward to get to the target
        ...
        //END CONE
        addParallel(new Action[] {new UnblockingMoveAction(-170 * Constants.ENCODER_PER_INCH, 0), new ReachLineWaitAction(false, -120 * Constants.ENCODER_PER_INCH)}, 8000);
