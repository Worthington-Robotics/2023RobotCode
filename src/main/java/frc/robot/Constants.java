...
public class Constants {
    ...
    public static class DriveTrain{
        ...
        public static final double X_MOVE_MAX = 4.5;
        public static final double Y_MOVE_MAX = 4.5;
    ...
    public static class Arm {
        ...
        public static final double EXTENSION_MIN_METERS = 0.66;
        ...
        public static final Vector<N3> ZERO_ANGLES = VecBuilder.fill(-1.33, 0.75, 1.25);
    ...
    public static class Field {
        ...
        public static final double BASE_TO_MID_X = 1.00;
