...
public class AutoRobotRelAction extends Action{
    ...
    public AutoRobotRelAction(double translationXSupplier, double translationYSupplier, double rotationSupplier) {
